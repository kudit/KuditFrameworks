...
After changing from 4.3, Test Versions Run with macCatalyst.
Update app icon template to be simple gradient on middle layer with circle hole, darker color for "background", and icon for foreground.
