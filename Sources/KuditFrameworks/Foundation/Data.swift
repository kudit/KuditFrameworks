...
//
// https://github.com/JJC1138/Data-Compression/blob/swift3/Data%2BCompression/Data%2BCompression.swift

/*
 TODO: Use native compression available after iOS 13
...
extension Data {
    ...
    private func data(using compression: Compression, operation: CompressionOperation) -> Data? {
        ...
        let outputData = try? withUnsafeBytes { (bytes: UnsafePointer<UInt8>) throws -> Data in
            ...
            repeat {
                ...
                case COMPRESSION_STATUS_ERROR:
                    throw NSCompressionFailedError
