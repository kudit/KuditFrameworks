...
public struct ComposeMailData {
    ...
    public var mailtoLink: URL {
        let link = URL(string: "mailto:\(recipients?.joined(separator: ",") ?? "EMAIL@NOT.SPECIFIED")?subject=\(subject.urlEncoded)&body=\(message.urlEncoded)") ?? URL(string: "https://www.apple.com")! // TODO: Encode Attachments
